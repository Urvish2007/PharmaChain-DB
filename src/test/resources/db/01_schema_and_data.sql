-- =====================================================================
-- schema_and_data.sql, as generated by the PharmaChain-DB project, with one
-- fix applied: the original file's `set search_path to pharma_manufacturing`
-- line (no trailing semicolon, and assumes the schema already exists) has been
-- replaced with an explicit CREATE SCHEMA + SET search_path pair below, so this
-- script can be run standalone against a brand-new database. Nothing else in
-- the DDL, triggers, views or procedure was changed.
-- =====================================================================
